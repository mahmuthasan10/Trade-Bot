...
- [x] Risk onayından geçen sinyallerin borsaya Async Emir (Market/Limit) olarak iletilmesi.
- [x] [cite_start]TP1 (%50), TP2 (%35) ve Trailing Stop (%15) kademeli çıkış mekanizmasının kodlanması[cite: 95].
- [x] [cite_start]Time-in-Trade (6 mum / 30dk hareketsizlikte kapat) kontrol döngüsünün yazılması[cite: 91].
- [x] Gerçekleşen işlemlerin PostgreSQL veritabanına kaydedilmesi.
